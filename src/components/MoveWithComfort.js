        ...
        <div className="col-md-6">
          <div className="text-content">
            ...
            <p className="text-dark-medium">
              Ryva connects people and businesses to reliable delivery partners
              that provide quick, cheap and delightful experiences. We are
              committed to bringing transparency, efficiency and speed,
